        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div style="font-weight:bold; color: white; font-size:large; border-radius:20px;" class="card text-center mb-3">
                    ...
                    <div class="card-body">
                        <h5 style="color: black;" class="card-title">{{ $jumlahKaryawan }}</h5>
                    </div>
                </div>
            </div>
            </a>
        ...
        <a href="/admin/data-stoks">
            <div class="col-md-3">
                <div style="font-weight:bold;color: white; font-size:large; border-radius:20px;" class="card text-center mb-3">
                    ...
                    <div class="card-body">
                        <h5 style="color: black;" class="card-title">{{ $jumlahBarangMasuk }}</h5>
                    </div>
                </div>
            </div>
        </a>
            ...
            <div class="col-md-3">
                <div style="font-weight:bold;color: white; font-size:large; border-radius:20px;" class="card text-center mb-3">
                    ...
                    <div class="card-body">
                        <h5 style="color: black;" class="card-title">{{ $jumlahBarangKeluar }}</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div style="font-weight:bold;color: white; font-size:large; border-radius:20px;" class="card text-center mb-3">
                    ...
                    <div class="card-body">
                        <h5 style="color: black;" class="card-title">{{ $jumlahStok }}</h5>
                    </div>
                </div>
            </div>
        </div>
